    ...
    def _create_test_tasks(self):
        ...
        tasks = [
            ...
            self.wfi.add_task(
                ...
                inputs=[StepInput("input0", "File", None, None, "compute0/output", "-i", 1),
                        StepInput("input1", "File", None, None, "compute1/output", "-i", 2),
                        StepInput("input2", "File", None, None, "compute2/output", "-i", 3)],
