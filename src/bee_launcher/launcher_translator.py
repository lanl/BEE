...
# project
from launcher_targets.tar_slurm import SlurmAdaptee
from launcher_targets.tar_ssh import SSHAdaptee
from launcher_targets.tar_localhost import LocalhostAdaptee
