...
# This whole script can be cleaned up. Lot's of stuff in here that
# isn't needed of you're not doing a Vagrabt install. [Al]
...
if [[ ${UBUNTU_VERSION} == 16.04 ]] || [[ ${UBUNTU_VERSION} == 16.10 ]]; then
    ...
    # provisioner.
    # Al thinks this is only needed for Vagrant, so he removed it.
