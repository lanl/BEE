...
class MockGDBDriver:
    ...
    interactions. This driver mock doesn't support multiple workflows per driver.
    """
...
class MockAlterConfig:
    """Mock AlterConfig."""

    def __init__(self, changes=None):
        """Initalize AlterConfig."""
        self.config = None
    ...
    def change_value(self, sec_name, opt_name, new_value):
        ...
        for sec_name, opts in self.config.items():
