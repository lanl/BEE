#!/bin/bash
# Checkpoint test script for done_marker mode
# This script is embedded as a pre-script in the CWL workflow

set -e

# Hardcoded values for done_marker mode
CHECKPOINT_DIR="checkpoint_output_done_marker"
ITERATIONS=3
RESTART_FILE=""
SENTINEL_MODE="done_marker"
RESTART_COUNT=0
...
case "$SENTINEL_MODE" in
  continue_file)
    # Mode 1: Create a "continue.file" file to indicate more work needed
